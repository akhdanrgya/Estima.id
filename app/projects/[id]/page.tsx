...
import { Building2, Calendar, MapPin, ShieldCheck, ArrowLeft, Image as ImageIcon } from 'lucide-react';
...
export default function ProjectDetail({ params }: { params?: { id: string } }) {
  ...
  const carouselImages = [project.image, project.image, project.image];
        ...
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <div className="prose max-w-none text-slate-600 text-lg leading-relaxed pt-4">
              <p>{project.desc}</p>
              <p>
                Sebagai salah satu pencapaian besar PT Estima Reka Sakti, proyek ini dieksekusi dengan standar Keselamatan dan Kesehatan Kerja (K3) yang sangat ketat di lingkungan industri berrisiko tinggi. 
                Tim engineer dan teknisi kami yang tersertifikasi berhasil menyelesaikan lingkup kerja <strong>{project.service}</strong> tanpa adanya <em>Lost Time Injury</em> (LTI), memastikan jadwal operasional pabrik klien berjalan sesuai target.
              </p>
            </div>
          </div>
