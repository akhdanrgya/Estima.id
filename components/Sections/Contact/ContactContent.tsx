            ...
            <div className="container mx-auto px-6">
                <div className="flex flex-col lg:flex-row gap-16">
                    ...
                    <div className="lg:w-5/12 space-y-12">
                        ...
                        {/* Map Placeholder */}
                        <div className="w-full h-64 bg-slate-100 rounded-2xl overflow-hidden relative border border-slate-200 group">
                            <div className="absolute inset-0 flex items-center justify-center text-slate-400 font-medium bg-slate-200/50">
                                [Google Maps Embed Placeholder]
                            </div>
                            <div className="absolute bottom-4 right-4 bg-white px-4 py-2 rounded-lg shadow-sm text-xs font-bold text-slate-600">
                                PT Estima Reka Sakti
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative">
                                            ...
                                            <input type="text" className="w-full bg-white border border-slate-200 p-4 pl-12 rounded-xl focus:outline-none focus:ring-2 transition-all" style={{ '--tw-ring-color': COLORS.primary }} placeholder="PT Maju Mundur" />
                                        </div>
                                    </div>
                                    <div className="space-y-2">
