  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-slate-50">
      ...
      <div className="container mx-auto px-6 relative z-10 grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          <motion.div variants={itemVariants} className="inline-flex items-center gap-2 px-4 py-1 rounded-full text-sm font-bold tracking-wide uppercase" style={{ backgroundColor: COLORS.primaryLight, color: COLORS.primary, borderColor: COLORS.primaryLight, borderWidth: '1px' }}>
            <Factory size={16} /> Industrial Services Partner
          </motion.div>

          <motion.h1 variants={itemVariants} className="text-5xl md:text-6xl font-extrabold text-slate-900 leading-[1.1]">
            Oil, Gas & Power <br />
          ...
          <motion.p variants={itemVariants} className="text-slate-600 text-lg md:text-xl max-w-lg leading-relaxed border-l-4 pl-4" style={{ borderColor: COLORS.secondary }}>
        ...
        >
          <motion.div variants={itemVariants} className="absolute inset-0 bg-[url('/hero2.jpg')] bg-cover bg-center rounded-2xl shadow-2xl hover:grayscale-0 transition-all duration-700"></motion.div>

          <motion.div variants={floatVariants} className="absolute top-10 -left-10 bg-white p-4 rounded-xl shadow-xl border border-slate-100 flex items-center gap-3 animate-float">
          ...
          <motion.div variants={floatVariants} className="absolute bottom-20 -right-10 bg-white p-4 rounded-xl shadow-xl border border-slate-100 flex items-center gap-3 animate-float-delayed">
