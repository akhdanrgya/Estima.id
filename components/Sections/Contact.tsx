  ...
  return (
    <section id="contact" className="py-24 bg-white">
      <div className="container mx-auto px-6">
        <motion.div
          className="bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col md:flex-row border border-slate-100"
        ...
        >
          ...
          <motion.div variants={itemVariants} className="md:w-5/12 bg-slate-900 p-10 text-white relative flex flex-col justify-between">
          ...
          <motion.div variants={itemVariants} className="md:w-7/12 p-10 md:p-12 bg-slate-50">
