      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          {servicesList.map((service, index) => (
            <motion.div variants={itemVariants} key={index} className="group p-8 rounded-2xl bg-white hover:bg-slate-50 border border-slate-100 shadow-sm hover:shadow-2xl transition-all duration-300 relative overflow-hidden w-full md:w-[calc(50%-1rem)] lg:w-[calc(33.33%-2rem)]" style={{ borderColor: 'transparent' }}>
