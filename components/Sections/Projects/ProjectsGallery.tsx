                ...
                <div className="flex flex-wrap gap-4 mb-12 justify-center md:justify-start">
                    {categories.map(cat => (
                        <button
                            ...
                            className={`px-6 py-2 rounded-full font-bold text-sm transition-all flex items-center gap-2 border ${filter === cat.id
                ...
                >
                    <AnimatePresence>
                        {filteredProjects.map((project) => (
                            ...
                            <motion.div variants={itemVariants} initial="hidden" animate="visible" exit="exit" layout key={project.id}>
                                <Link
