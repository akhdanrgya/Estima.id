...
const SafetyCertificates = () => {
    const awards = [
        ...
        {
            id: 3,
            name: "Shell Chrysalis Project",
            title: "3 Million Safe Man-Hours",
            desc: "Appreciated for our strong commitment to safety excellence at the Shell Chrysalis Project, successfully delivering 3 million cumulative work hours without a Lost Time Injury (LTI).",
            img: "/certificates/SafetyApperciation4.jpeg"
        },
    ];
